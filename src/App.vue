  ...
  div.flex.flex-col.h-full
    ...
    .main.max-w-6xl.mx-auto.flex-1.p-5.w-full
      ...
      section.fillupsapp(v-cloak)
        ...
        form.border-solid.border-red-500.border-2.px-4.py-4.rounded(v-on:submit.prevent v-if="show_new_fillup")
          .flex.flex-wrap.-m-3
            ...
            div.flex.flex-wrap.w-40.items-center.m-3
              ...
              select#new_car(v-model="fillup_car" class="bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-4 rounded leading-tight focus:outline-none focus:shadow-outline block w-full mt-2")
            ...
            label.m-3
              ...
              flat-pickr(v-model="fillup_date" :config="flatpickr_config" class="bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-4 rounded leading-tight focus:outline-none focus:shadow-outline w-56")
            label.m-3
              p.text-gray-700.mb-2 Starting Odometer
              input.fillup-starting-odo(type="number" v-model="fillup_starting_odo" pattern="\d*" step="0.001" class="w-40 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 rounded leading-tight focus:outline-none focus:shadow-outline")
            label.m-3
              p.text-gray-700.mb-2 Ending Odometer
              input.fillup-ending-odo(type="number" v-model="fillup_ending_odo" pattern="\d*" step="0.001" class="w-40 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 rounded leading-tight focus:outline-none focus:shadow-outline") 
            label.m-3
            ...
            label.m-3
              ...
              input.fillup-gallons(type="number" v-model="fillup_gallons" pattern="\d*" step="0.001" class="w-40 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 rounded leading-tight focus:outline-none focus:shadow-outline")
          div
        ...
        div(v-for="fillup in recentFillups" v-bind:key="fillup.id").border-t-2.border-gray-500.border-solid
          form.border-solid.border-red-500.border-2.px-4.py-4.rounded.my-5(v-if="fillup.editing" v-on:submit.prevent="doFillupEdit(fillup)")
            .flex.flex-wrap.-m-3
              ...
              div.flex.flex-wrap.w-40.items-center.m-3
                ...
                select#new_car(v-model="fillup.car" class="bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-4 rounded leading-tight focus:outline-none focus:shadow-outline block w-full mt-2")
                  option(value='' disabled) -- Select a Car --
                  option(v-for="car in uniqueCars" :value="car.car") {{car.car}}
              ...
              label.m-3
                ...
                flat-pickr(v-model="fillup.date" :config="flatpickr_config" class="bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-4 rounded leading-tight focus:outline-none focus:shadow-outline w-56")
              label.m-3
                p.text-gray-700.mb-2 Starting Odometer
                input(type="number" v-model="fillup.starting_odo" pattern="\d*" step="0.001" class="bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 rounded leading-tight focus:outline-none focus:shadow-outline w-40") 
              label.m-3
                p.text-gray-700.mb-2 Ending Odometer            
                input(type="number" v-model="fillup.ending_odo" pattern="\d*" step="0.001" class="bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 rounded leading-tight focus:outline-none focus:shadow-outline w-40") 
              label.m-3
                p.text-gray-700.mb-2 Miles
              ...
              label.m-3
                p.text-gray-700.mb-2 Gallons
                input(type="number" v-model="fillup.gallons" pattern="\d*" step="0.001" class="bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 rounded leading-tight focus:outline-none focus:shadow-outline w-40 mr-4") 
