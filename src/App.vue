        ...
        form.border-solid.border-red-500.border-2.px-4.py-4.rounded(v-on:submit.prevent v-if="show_new_fillup")
          .flex.flex-wrap.-m-3
            ...
            label.m-3
              ...
              input.fillup-starting-odo(type="text" v-model="fillup_starting_odo" class="w-40 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline")
            label.m-3
              p.text-gray-700.mb-2 Ending Odometer
              input.fillup-ending-odo(type="text" v-model="fillup_ending_odo" class="w-40 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline") 
            label.m-3
              p.text-gray-700.mb-2 Miles      
              div.leading-tight.py-2(v-if="fillup_ending_odo && fillup_starting_odo") {{fillup_ending_odo - fillup_starting_odo}}
            label.m-3
              p.text-gray-700.mb-2 Gallons
              input.fillup-gallons(type="text" v-model="fillup_gallons" class="w-40 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline")
        ...
        div(v-for="fillup in recentFillups").border-t-2.border-gray-500.border-solid
          form.border-solid.border-red-500.border-2.px-4.py-4.rounded.my-5(v-if="fillup.editing" v-on:submit.prevent="doFillupEdit(fillup)")
            .flex.flex-wrap.-m-3
              ...
              label.m-3
                p.text-gray-700.mb-2 Starting Odometer
                input(type="text" v-model="fillup.starting_odo" class="bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline w-40") 
              label.m-3
                p.text-gray-700.mb-2 Ending Odometer            
                input(type="text" v-model="fillup.ending_odo" class="bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline w-40") 
              label.m-3
                p.text-gray-700.mb-2 Miles
                div.leading-tight.py-2(v-if="fillup.ending_odo && fillup.starting_odo") {{fillup.ending_odo - fillup.starting_odo}}

              label.m-3
                p.text-gray-700.mb-2 Starting Odometer              
                input(type="text" v-model="fillup.gallons" class="bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline w-40 mr-4") 
